    ...
    <article>
      ...
      <div className="docs-prose mt-8">
        ...
        <p>
          ...
          than one of each. Splitting pulls SY from your wallet, so the first split needs an
          ERC-20 approval for the <code>Tokenizer</code>; the app requests it automatically when
