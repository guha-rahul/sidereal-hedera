    ...
    <article>
      ...
      <div className="docs-prose mt-8">
        ...
        <p>
          ...
          <Link href="/docs/amm">AMM and YT routing</Link>. Every route is an ERC-20 transfer into
          the AMM, so the first swap of each asset asks for an approval; the app reuses it on later
          trades.
        </p>
