    ...
    <article>
      ...
      <div className="docs-prose mt-8">
        ...
        <p>
          ...
          balances runs out first. Adding liquidity moves both PT and SY into the AMM, so it needs
          an ERC-20 approval for each asset. The preview shows <strong>LP minted</strong>, your{" "}
        ...
        <ul>
          ...
          <li>
            ...
            toward one as maturity approaches. Because the AMM converts SY shares to asset units
            before pricing, that convergence is measured in the same units the tokenizer redeems
            in.
          </li>
        </ul>
        ...
        <p>
          ...
          wind-down after maturity too. LP balances live in the AMM&rsquo;s contract storage, which
          is permanent and does not expire (see{" "}
